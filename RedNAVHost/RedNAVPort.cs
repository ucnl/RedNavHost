...
namespace RedNAVHost
{
    ...
    public class TrackItem : RNGeoPoint3D
    {      
    ...
    public class RNGeoPoint2D
    {
        public double Latitude;
        public double Longitude;
        public int PType;

        public RNGeoPoint2D(double lat, double lon, int type)
        {
            Latitude = lat;
            Longitude = lon;
            PType = type;
    ...
    public class RNGeoPoint3D : RNGeoPoint2D
    {
        public double Depth;

        public RNGeoPoint3D(double lat, double lon, double dpt) : base(lat, lon, 3)
        {
            Depth = dpt;
        }
